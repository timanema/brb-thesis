...
\multicolumn{1}{|c|}{ORD.1}       & 9.15\% (?\%)            & always               & 7.1\% (?\%)             & always               & 9.46\% (?\%)            & always               & 9.43\% (?\%)             & always               \\ \hline
\multicolumn{1}{|c|}{ORD.2}       & 34.06\% (?\%)            & always               & 34.23\% (?\%)             & always               & 33.91\% (?\%)            & always               & 33.91\% (?\%)             & always               \\ \hline
\multicolumn{1}{|c|}{ORD.3}       & 62.89\% (?\%)            & always               & 2.36\% (?\%)             & always               & 62.82\% (?\%)            & always               & 58.39\% (?\%)             & always               \\ \hline
\multicolumn{1}{|c|}{ORD.4}       & 10\% (2\%)            & always               & 10\% (2\%)             & always               & 10\% (2\%)            & always               & 10\% (2\%)             & always               \\ \hline
\multicolumn{1}{|c|}{ORD.5}       & ?\% (?\%)            & always               & ?\% (?\%)             & always               & ?\% (?\%)            & always               & ?\% (?\%)             & always               \\ \hline
\multicolumn{1}{|c|}{ORD.6}       & ?\% (?\%)            & always               & ?\% (?\%)             & always               & ?\% (?\%)            & always               & ?\% (?\%)             & always               \\ \hline
\multicolumn{1}{|c|}{ORD.7}       & ?\% (?\%)            & always               & ?\% (?\%)             & always               & ?\% (?\%)            & always               & ?\% (?\%)             & always               \\ \hline
