...
% Depending on how the protocols are applied, our work could reduce network and system usage. This leads to either a higher capacity of the broadcast layer or a reduced energy footprint of the system. The latter always has a positive impact, while the former can be negative if the system in question is malicious.
...
% To conclude, we believe our research does not have a significant negative impact. Furthermore, everyone should be able to run our evaluation program themselves and verify our results. If desired, one can also implement our optimizations in another language using the descriptions and pseudocode we provided.